...
SUPERSEDED = {
    ...
    # A planning placeholder: closed-form trends plus seeded noise, labelled
    # "Proposed method". With MOCK = False it lost its watermark and still ran
    # as the release's "synthetic sweep figure" step. No paper uses it; the
    # real synthetic evidence is results/synthetic_suite*.csv. Retired 2026-09-23.
    "fig_synthetic": "nothing -- it drew invented curves, and no article inputs it",
}
...
if __name__ == "__main__":
    print("make_figures.py draws nothing any more. The article's figures are generated by "
          "make_pgf.py and make_heatmaps.py; see SUPERSEDED for what each old figure became.")
    if MOCK:
